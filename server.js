...
        this.state = {
            players: [],
            teams: {}, // NEW: Store teams dynamically
            objects: [],
...
        const newPlayer = {
            id: newId, x: 0, y: 0, team: null, // MODIFIED: No team on creation
...
        this.state.teams[newTeamId] = { id: newTeamId, name: teamName, members: [], color: color };
